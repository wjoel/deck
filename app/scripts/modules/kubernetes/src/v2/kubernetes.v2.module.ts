...
import { KUBERNETES_FIND_MANIFEST_FROM_CLUSTER_STAGE } from './pipelines/stages/findManifestFromCluster/findManifestFromClusterStage';
...
module(KUBERNETES_V2_MODULE, [
  ...
  KUBERNETES_FIND_MANIFEST_FROM_CLUSTER_STAGE,
